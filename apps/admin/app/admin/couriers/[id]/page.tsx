...
import {
  getAdminCourierProfile,
  type AdminCourierDepotAccess,
  type AdminCourierProfileAuditItem,
  type AdminCourierProfileDocument,
  type AdminCourierProfileInfoItem,
  type AdminCourierProfileNote,
  type AdminCourierProfileShift,
      ...
      <section className="rounded-2xl border border-border bg-surface p-6 shadow-card">
        <div className="grid gap-6 xl:grid-cols-[220px_minmax(0,1fr)]">
          <div className="flex flex-col items-center rounded-2xl border border-border-light bg-surface-secondary p-4 text-center">
            ...
            <span
              className={`mt-4 inline-flex h-2.5 w-2.5 rounded-full ${toneClasses[courier.statusTone].dot}`}
              aria-hidden="true"
            />
          ...
          <div className="grid gap-5 lg:grid-cols-3">
            <InfoList items={courier.personalData} />
            <InfoList items={courier.accountData} />
          ...
          <DetailCard title="Einladung und Konto">
            <InfoList
              items={[
                {
                  label: "Einladung",
                  value: courier.invitationStatusLabel,
                  tone:
                ...
                { label: "Freigegeben am", value: courier.approvedAt },
                { label: "Freigegeben durch", value: courier.approvedBy },
              ]}
            />
          </DetailCard>

          <DetailCard title="Access History">
            <AuditList items={courier.accessHistory} />
